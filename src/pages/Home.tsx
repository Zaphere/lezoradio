    ...
    <div className="relative min-h-screen bg-bg-primary transition-colors duration-300">
      <div className="max-w-lg mx-auto px-4 pt-6 pb-8 flex flex-col gap-6">
        <div className="text-center">
          <h1 className="text-[32px] font-bold text-[#111111] dark:text-[#F1F5F9] tracking-tight">
            Radiolezo
          </h1>
          <p className="text-base text-[#555555] dark:text-[#94A3B8] mt-1">
        ...
        <div className="bg-white dark:bg-white/5 rounded-3xl shadow-[0_4px_16px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.3)] p-6">
          <h2 className="flex items-center justify-center gap-2 text-base font-semibold text-[#555555] dark:text-[#94A3B8] mb-4">
